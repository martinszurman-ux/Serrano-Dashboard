...
# 3. CSS MAESTRO - BOTONES SIMÉTRICOS Y SIN ERRORES
st.markdown("""
<style>
    .stApp { background-color: white !important; color: #31333F !important; }
    [data-testid="stSidebar"] { background-color: #f0f2f6 !important; }

    /* FORZAR ANCHO 100% EN CONTENEDORES DE BOTONES */
    div[data-testid="stVerticalBlock"] div[data-testid="stVerticalBlock"] > div {
        width: 100% !important;
    }

    /* ESTILO DE BOTONES: Bloques idénticos al 100% de ancho */
    .stButton > button {
        width: 100% !important;
    ...
    /* BOTÓN ADHESIÓN: Mismo tamaño, color negro */
